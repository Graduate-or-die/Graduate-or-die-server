...
public class EducationController {
  ...
  public ResponseEntity<BaseResponse<SaveUpdateEducationResponse>> saveEducation(
      ...
      @Valid @RequestBody SaveEducationRequest request) {
    User user = (User) authentication.getPrincipal();

    SaveUpdateEducationResponse result = educationService.saveEducation(user.getId(), request);
  ...
  public ResponseEntity<BaseResponse<SaveUpdateEducationResponse>> updateEducation(
    ...
    User user = (User) authentication.getPrincipal();
    SaveUpdateEducationResponse result = educationService.updateEducation(user.getId(), request);
