...
public class QualificationService {
  ...
  // 자격증 저장
  public SaveUpdateQualificationResponse saveQualification(
      Long userId,
      SaveQualificationRequest request,
    ...
    validateDateRange(request.getQualificationStartAt(), request.getQualificationEndAt());
  ...
  // 자격증 수정
  public SaveUpdateQualificationResponse updateQualification(
      Long userId,
    ...
    String qualificationName = request.getQualificationName() != null && !request.getQualificationName().isEmpty()
        ? request.getQualificationName() : qualification.getQualificationName();
    String qualificationOrganization = request.getQualificationOrganization() != null && !request.getQualificationOrganization().isEmpty()
        ? request.getQualificationOrganization() : qualification.getQualificationOrganization();
    LocalDate qualificationStartAt = request.getQualificationStartAt() != null
        ? request.getQualificationStartAt() : qualification.getQualificationStartAt();
    LocalDate qualificationEndAt = request.getQualificationEndAt() != null
        ? request.getQualificationEndAt() : qualification.getQualificationEndAt();
  ...
  public void deleteQualification(Long blockId, Long userId) {
