...
public enum BaseResponseStatus {
  ...
  CSV_PARSE_ERROR(false, HttpStatus.INTERNAL_SERVER_ERROR, 2111, "CSV 파싱 중 오류가 발생했습니다."),
  ...
  // embedding
  INVALID_EMBEDDING_RESPONSE(false, HttpStatus.INTERNAL_SERVER_ERROR, 2120, "유효하지 않은 임베딩 응답이 생성되었습니다."),
