...
public class EtcController {
  ...
  public ResponseEntity<BaseResponse<SaveUpdateEtcResponse>> saveEtc(
      ...
      @Valid @RequestBody SaveEtcRequest request
  ) {
    User user = (User) authentication.getPrincipal();
    SaveUpdateEtcResponse result = etcService.saveEtc(user.getId(), request);
  ...
  public ResponseEntity<BaseResponse<SaveUpdateEtcResponse>> updateEtc(
      Authentication authentication,
      @Valid @RequestBody UpdateEtcRequest request) {
    User user = (User) authentication.getPrincipal();
    SaveUpdateEtcResponse result = etcService.updateEtcResponse(user.getId(), request);
